...
const ITEMS_DB = {
  ...
  f_armr_1: {id:'f_armr_1', name:'Cloth Robe',          slot:'armor',    rarity:'common',    emoji:'👕', img:'img/forge/armor1.png', crafted:true, tree:'armr', tier:1, stats:{CON:2,DEF:3},                         desc:'Simple cloth. Better than nothing.'},
  f_armr_2: {id:'f_armr_2', name:'Leather Tunic',        slot:'armor',    rarity:'common',    emoji:'🥋', img:'img/forge/armor2.png', crafted:true, tree:'armr', tier:2, stats:{CON:3,DEF:6},                         desc:'Tanned hide. Light and serviceable.'},
  f_armr_3: {id:'f_armr_3', name:'Studded Leather',      slot:'armor',    rarity:'uncommon',  emoji:'🥋', img:'img/forge/armor3.png', crafted:true, tree:'armr', tier:3, stats:{CON:6,DEF:11,HP:15},                  desc:'Metal studs reinforce every weak point.'},
  f_armr_4: {id:'f_armr_4', name:'Chain Mail',           slot:'armor',    rarity:'uncommon',  emoji:'🪖', img:'img/forge/armor4.png', crafted:true, tree:'armr', tier:4, stats:{CON:10,DEF:18,HP:30},                 desc:'Interlinked rings. Reliable protection.'},
  f_armr_5: {id:'f_armr_5', name:'Scale Mail',           slot:'armor',    rarity:'rare',      emoji:'🦾', img:'img/forge/armor5.png', crafted:true, tree:'armr', tier:5, stats:{CON:16,DEF:28,HP:55},                 desc:'Overlapping scales, forged from consistent work.'},
  f_armr_6: {id:'f_armr_6', name:'Steel Plate',          slot:'armor',    rarity:'rare',      emoji:'🔩', img:'img/forge/armor6.png', crafted:true, tree:'armr', tier:6, stats:{CON:22,DEF:38,HP:80,blockBonus:2},    desc:'Full plate forged through months of habit.'},
  f_armr_7: {id:'f_armr_7', name:'Guardian Plate',       slot:'armor',    rarity:'epic',      emoji:'⚙️', img:'img/forge/armor7.png', crafted:true, tree:'armr', tier:7, stats:{CON:30,DEF:52,HP:120,blockBonus:4},   desc:'Blessed by those who never faltered.'},
  f_armr_8: {id:'f_armr_8', name:'Dragon Scale Armor',   slot:'armor',    rarity:'epic',      emoji:'🐉', img:'img/forge/armor8.png', crafted:true, tree:'armr', tier:8, stats:{CON:40,DEF:68,HP:170,blockBonus:7},   desc:'Scales of ambition, layered over months.'},
  f_armr_9: {id:'f_armr_9', name:'Celestial Regalia',    slot:'armor',    rarity:'legendary', emoji:'✨', img:'img/forge/armor9.png', crafted:true, tree:'armr', tier:9, stats:{CON:54,DEF:90,HP:240,blockBonus:10},  desc:'The armor of those who transcended their limits.'},
  ...
  f_helm_1: {id:'f_helm_1', name:'Padded Coif',       slot:'helmet',   rarity:'common',    emoji:'🪖', img:'img/forge/helmet1.png', crafted:true, tree:'helm', tier:1, stats:{CON:1,DEF:2},                          desc:'Modest padding. A small comfort.'},
  f_helm_2: {id:'f_helm_2', name:'Iron Helm',          slot:'helmet',   rarity:'common',    emoji:'⛑️',  img:'img/forge/helmet2.png', crafted:true, tree:'helm', tier:2, stats:{CON:2,DEF:4},                          desc:'Solid iron. No frills.'},
  f_helm_3: {id:'f_helm_3', name:"Soldier's Helm",     slot:'helmet',   rarity:'uncommon',  emoji:'⛑️',  img:'img/forge/helmet3.png', crafted:true, tree:'helm', tier:3, stats:{CON:5,DEF:8,STR:2},                   desc:'Worn by those who commit to the front line.'},
  f_helm_4: {id:'f_helm_4', name:"Knight's Visor",     slot:'helmet',   rarity:'uncommon',  emoji:'🛡️', img:'img/forge/helmet4.png', crafted:true, tree:'helm', tier:4, stats:{CON:8,DEF:12,STR:5,INT:3},             desc:'Half-plate visor. Protects mind and body.'},
  f_helm_5: {id:'f_helm_5', name:'Mage Hat',           slot:'helmet',   rarity:'rare',      emoji:'🎩', img:'img/forge/helmet5.png', crafted:true, tree:'helm', tier:5, stats:{INT:12,VOL:6,MP:22,CHA:3},             desc:'Channels arcane energy through focused study.'},
  f_helm_6: {id:'f_helm_6', name:'War Crown',          slot:'helmet',   rarity:'rare',      emoji:'👑', img:'img/forge/helmet6.png', crafted:true, tree:'helm', tier:6, stats:{CON:12,INT:14,DEF:14,MP:30},           desc:'Forged for those who lead through knowledge.'},
  f_helm_7: {id:'f_helm_7', name:'Arcane Visage',      slot:'helmet',   rarity:'epic',      emoji:'🔮', img:'img/forge/helmet7.png', crafted:true, tree:'helm', tier:7, stats:{INT:22,VOL:15,MP:60,CHA:8},            desc:'A mask of crystallized mental discipline.'},
  f_helm_8: {id:'f_helm_8', name:'Void Visor',         slot:'helmet',   rarity:'epic',      emoji:'🌌', img:'img/forge/helmet8.png', crafted:true, tree:'helm', tier:8, stats:{INT:30,VOL:22,MP:85,CHA:12},           desc:'Sees through illusion. Forged through relentless thought.'},
  f_helm_9: {id:'f_helm_9', name:'Eternal Crown',      slot:'helmet',   rarity:'legendary', emoji:'👑', img:'img/forge/helmet9.png', crafted:true, tree:'helm', tier:9, stats:{INT:42,VOL:30,MP:115,CHA:18},          desc:'Worn by those who never stopped learning.'},
  ...
  f_shld_1: {id:'f_shld_1', name:'Wooden Buckler',   slot:'shield',   rarity:'common',    emoji:'🛡️', img:'img/forge/shield1.png', crafted:true, tree:'shld', tier:1, stats:{CON:1,DEF:4},                          desc:'Rough wood. Barely counts.'},
  f_shld_2: {id:'f_shld_2', name:'Iron Targe',        slot:'shield',   rarity:'common',    emoji:'🛡️', img:'img/forge/shield2.png', crafted:true, tree:'shld', tier:2, stats:{CON:2,DEF:7},                          desc:'Small and reliable. Good practice.'},
  f_shld_3: {id:'f_shld_3', name:'Steel Shield',      slot:'shield',   rarity:'uncommon',  emoji:'🛡️', img:'img/forge/shield3.png', crafted:true, tree:'shld', tier:3, stats:{CON:5,DEF:12,blockBonus:1},            desc:'Hammered steel with a sturdy grip.'},
  f_shld_4: {id:'f_shld_4', name:"Knight's Shield",   slot:'shield',   rarity:'uncommon',  emoji:'🛡️', img:'img/forge/shield4.png', crafted:true, tree:'shld', tier:4, stats:{CON:8,DEF:18,HP:15,blockBonus:2},     desc:'Crest-emblazoned. For committed warriors.'},
  f_shld_5: {id:'f_shld_5', name:'Tower Shield',      slot:'shield',   rarity:'rare',      emoji:'🛡️', img:'img/forge/shield5.png', crafted:true, tree:'shld', tier:5, stats:{CON:14,DEF:27,HP:35,blockBonus:3},    desc:'Unwieldy but impenetrable.'},
  f_shld_6: {id:'f_shld_6', name:'Bulwark',           slot:'shield',   rarity:'rare',      emoji:'🔱', img:'img/forge/shield6.png', crafted:true, tree:'shld', tier:6, stats:{CON:20,DEF:37,HP:60,blockBonus:5},    desc:'A fortress in hand.'},
  f_shld_7: {id:'f_shld_7', name:'Guardian Aegis',    slot:'shield',   rarity:'epic',      emoji:'🛡️', img:'img/forge/shield7.png', crafted:true, tree:'shld', tier:7, stats:{CON:28,DEF:50,HP:95,blockBonus:7},    desc:'Inscribed with the names of all protected.'},
  f_shld_8: {id:'f_shld_8', name:'Divine Barrier',    slot:'shield',   rarity:'epic',      emoji:'🔷', img:'img/forge/shield8.png', crafted:true, tree:'shld', tier:8, stats:{CON:38,DEF:65,HP:135,blockBonus:9},   desc:'Absorbs harm with unwavering resolve.'},
  f_shld_9: {id:'f_shld_9', name:'Fortress Wall',     slot:'shield',   rarity:'legendary', emoji:'🔱', img:'img/forge/shield9.png', crafted:true, tree:'shld', tier:9, stats:{CON:50,DEF:85,HP:185,blockBonus:12},  desc:'Engineered through absolute operational excellence.'},

  // 📿 NECKLACE TREE — necklace — scroll primary, crystal secondary, gear T7+
  f_neck_1: {id:'f_neck_1', name:'Copper Chain',        slot:'necklace', rarity:'common',    emoji:'📿', img:'img/forge/necklace1.png', crafted:true, tree:'neck', tier:1, stats:{INT:1,HP:8},                           desc:'Simple. Functional. A starting point.'},
  f_neck_2: {id:'f_neck_2', name:'Jade Pendant',         slot:'necklace', rarity:'common',    emoji:'💚', img:'img/forge/necklace2.png', crafted:true, tree:'neck', tier:2, stats:{INT:2,VOL:1,HP:14},                   desc:'Carved jade from a calm, focused mind.'},
  f_neck_3: {id:'f_neck_3', name:'Mana Bead',            slot:'necklace', rarity:'uncommon',  emoji:'🔵', img:'img/forge/necklace3.png', crafted:true, tree:'neck', tier:3, stats:{INT:5,VOL:3,MP:12},                   desc:'A crystal bead that amplifies focus.'},
  f_neck_4: {id:'f_neck_4', name:'Arcane Pendant',       slot:'necklace', rarity:'uncommon',  emoji:'📿', img:'img/forge/necklace4.png', crafted:true, tree:'neck', tier:4, stats:{INT:9,VOL:6,MP:25},                   desc:'Crystallized thought. Knowledge made tangible.'},
  f_neck_5: {id:'f_neck_5', name:"Scholar's Pendant",    slot:'necklace', rarity:'rare',      emoji:'🔮', img:'img/forge/necklace5.png', crafted:true, tree:'neck', tier:5, stats:{INT:14,VOL:9,MP:40,CHA:3},            desc:'For those who never stopped studying.'},
  f_neck_6: {id:'f_neck_6', name:'Void Chain',           slot:'necklace', rarity:'rare',      emoji:'💎', img:'img/forge/necklace6.png', crafted:true, tree:'neck', tier:6, stats:{INT:20,VOL:13,MP:60,CHA:6},           desc:'Tethered to a dimension of pure thought.'},
  f_neck_7: {id:'f_neck_7', name:"Sage's Necklace",      slot:'necklace', rarity:'epic',      emoji:'📿', img:'img/forge/necklace7.png', crafted:true, tree:'neck', tier:7, stats:{INT:27,VOL:18,MP:85,CHA:10},          desc:'Worn by those who see further than others.'},
  f_neck_8: {id:'f_neck_8', name:'Elemental Seal',       slot:'necklace', rarity:'epic',      emoji:'🌀', img:'img/forge/necklace8.png', crafted:true, tree:'neck', tier:8, stats:{INT:36,VOL:24,MP:115,CHA:15},         desc:'Seals bound through relentless mental discipline.'},
  f_neck_9: {id:'f_neck_9', name:"Sage's Relic",         slot:'necklace', rarity:'legendary', emoji:'🔮', img:'img/forge/necklace9.png', crafted:true, tree:'neck', tier:9, stats:{INT:48,VOL:32,MP:155,CHA:22},         desc:'A relic of absolute wisdom, forged through years.'},
  ...
  f_earr_1: {id:'f_earr_1', name:'Copper Stud',      slot:'earring',  rarity:'common',    emoji:'💎', img:'img/forge/earring1.png', crafted:true, tree:'earr', tier:1, stats:{DEX:1,CHA:1},                           desc:'Simple studs. Easy to make, easy to wear.'},
  ...
  f_earr_3: {id:'f_earr_3', name:'Gem Earring',       slot:'earring',  rarity:'uncommon',  emoji:'💠', img:'img/forge/earring3.png', crafted:true, tree:'earr', tier:3, stats:{DEX:5,CHA:4},                           desc:'A gemstone set with precision.'},
  f_earr_4: {id:'f_earr_4', name:'Wind Earring',      slot:'earring',  rarity:'uncommon',  emoji:'💨', img:'img/forge/earring4.png', crafted:true, tree:'earr', tier:4, stats:{DEX:8,CHA:6,dodgeBonus:1},              desc:'Whispers of speed in every move.'},
  f_earr_5: {id:'f_earr_5', name:'Shadow Earring',    slot:'earring',  rarity:'rare',      emoji:'🌑', img:'img/forge/earring5.png', crafted:true, tree:'earr', tier:5, stats:{DEX:12,CHA:9,dodgeBonus:2},             desc:'Crafted from the essence of subtlety.'},
  f_earr_6: {id:'f_earr_6', name:'Crystal Earring',   slot:'earring',  rarity:'rare',      emoji:'💎', img:'img/forge/earring6.png', crafted:true, tree:'earr', tier:6, stats:{DEX:17,CHA:13,dodgeBonus:4},            desc:'Carries the spark of creative mastery.'},
  f_earr_7: {id:'f_earr_7', name:'Arcane Earring',    slot:'earring',  rarity:'epic',      emoji:'✨', img:'img/forge/earring7.png', crafted:true, tree:'earr', tier:7, stats:{DEX:23,CHA:18,VOL:5,dodgeBonus:5},      desc:'Resonates with studied arcane frequency.'},
  f_earr_8: {id:'f_earr_8', name:'Phoenix Jewel',     slot:'earring',  rarity:'epic',      emoji:'🔥', img:'img/forge/earring8.png', crafted:true, tree:'earr', tier:8, stats:{DEX:30,CHA:24,VOL:9,dodgeBonus:7},      desc:'Burns with the light of creative rebirth.'},
  ...
  f_belt_1: {id:'f_belt_1', name:'Cloth Wraps',         slot:'belt',     rarity:'common',    emoji:'🥊', img:'img/forge/gauntlets1.png', crafted:true, tree:'belt', tier:1, stats:{CON:1,HP:8},                           desc:'Simple wrappings. Protect the knuckles.'},
  f_belt_2: {id:'f_belt_2', name:'Leather Gauntlets',   slot:'belt',     rarity:'common',    emoji:'🥊', img:'img/forge/gauntlets2.png', crafted:true, tree:'belt', tier:2, stats:{CON:2,HP:18},                          desc:'Tanned leather. Reliable daily use.'},
  f_belt_3: {id:'f_belt_3', name:'Reinforced Gauntlets',slot:'belt',     rarity:'uncommon',  emoji:'🥊', img:'img/forge/gauntlets3.png', crafted:true, tree:'belt', tier:3, stats:{CON:4,HP:32,DEF:3},                   desc:'Metal plates reinforce every knuckle.'},
  f_belt_4: {id:'f_belt_4', name:"Warrior's Gauntlets", slot:'belt',     rarity:'uncommon',  emoji:'🥊', img:'img/forge/gauntlets4.png', crafted:true, tree:'belt', tier:4, stats:{CON:7,HP:52,STR:4,DEF:5},             desc:'Thick leather worn by hardened warriors.'},
  f_belt_5: {id:'f_belt_5', name:'Battle Gauntlets',    slot:'belt',     rarity:'rare',      emoji:'🥊', img:'img/forge/gauntlets5.png', crafted:true, tree:'belt', tier:5, stats:{CON:11,HP:80,STR:7,DEF:8},            desc:'For those who fight on every front.'},
  f_belt_6: {id:'f_belt_6', name:"Engineer's Gauntlets",slot:'belt',     rarity:'rare',      emoji:'🔧', img:'img/forge/gauntlets6.png', crafted:true, tree:'belt', tier:6, stats:{CON:16,HP:115,STR:11,DEF:12},         desc:'Every joint tightened. Every system accounted for.'},
  f_belt_7: {id:'f_belt_7', name:"Titan's Grasp",       slot:'belt',     rarity:'epic',      emoji:'🏺', img:'img/forge/gauntlets7.png', crafted:true, tree:'belt', tier:7, stats:{CON:22,HP:160,STR:16,DEF:17},         desc:'A grip of immovable conviction.'},
  f_belt_8: {id:'f_belt_8', name:"Champion's Gauntlets",slot:'belt',     rarity:'epic',      emoji:'🏆', img:'img/forge/gauntlets8.png', crafted:true, tree:'belt', tier:8, stats:{CON:30,HP:215,STR:21,DEF:23},         desc:'Earned through months of unbroken output.'},
  f_belt_9: {id:'f_belt_9', name:'Eternal Gauntlets',   slot:'belt',     rarity:'legendary', emoji:'♾️', img:'img/forge/gauntlets9.png', crafted:true, tree:'belt', tier:9, stats:{CON:40,HP:280,STR:28,DEF:30},         desc:'Gauntlets of endless endurance. Woven from pure will.'},
  ...
  f_boot_1: {id:'f_boot_1', name:'Sandals',            slot:'boots',    rarity:'common',    emoji:'👟', img:'img/forge/boots1.png', crafted:true, tree:'boot', tier:1, stats:{DEX:1,HP:5},                           desc:'Light footwear. The journey begins here.'},
  f_boot_2: {id:'f_boot_2', name:'Leather Boots',       slot:'boots',    rarity:'common',    emoji:'👢', img:'img/forge/boots2.png', crafted:true, tree:'boot', tier:2, stats:{DEX:2,HP:10},                          desc:'Sturdy leather for the long haul.'},
  f_boot_3: {id:'f_boot_3', name:"Ranger's Boots",      slot:'boots',    rarity:'uncommon',  emoji:'👢', img:'img/forge/boots3.png', crafted:true, tree:'boot', tier:3, stats:{DEX:5,HP:15,dodgeBonus:1},             desc:'Made for those who cover distance every day.'},
  f_boot_4: {id:'f_boot_4', name:"Scout's Greaves",     slot:'boots',    rarity:'uncommon',  emoji:'🥾', img:'img/forge/boots4.png', crafted:true, tree:'boot', tier:4, stats:{DEX:8,CON:3,dodgeBonus:2},             desc:'Reinforced for terrain that fights back.'},
  f_boot_5: {id:'f_boot_5', name:'Swift Boots',         slot:'boots',    rarity:'rare',      emoji:'💨', img:'img/forge/boots5.png', crafted:true, tree:'boot', tier:5, stats:{DEX:13,CON:5,dodgeBonus:3},            desc:'Enchanted for quick movement and quiet steps.'},
  f_boot_6: {id:'f_boot_6', name:'Shadow Boots',        slot:'boots',    rarity:'rare',      emoji:'🌑', img:'img/forge/boots6.png', crafted:true, tree:'boot', tier:6, stats:{DEX:19,CON:8,dodgeBonus:5},            desc:'Leave no trace. Move like intention.'},
  f_boot_7: {id:'f_boot_7', name:'Storm Treads',        slot:'boots',    rarity:'epic',      emoji:'⚡', img:'img/forge/boots7.png', crafted:true, tree:'boot', tier:7, stats:{DEX:26,CON:12,dodgeBonus:7},           desc:'Speed forged through relentless motion.'},
  f_boot_8: {id:'f_boot_8', name:'Phantom Steps',       slot:'boots',    rarity:'epic',      emoji:'👻', img:'img/forge/boots8.png', crafted:true, tree:'boot', tier:8, stats:{DEX:34,CON:16,dodgeBonus:9},          desc:'Move before thought. React before reaction.'},
  f_boot_9: {id:'f_boot_9', name:'Void Walker',         slot:'boots',    rarity:'legendary', emoji:'🌌', img:'img/forge/boots9.png', crafted:true, tree:'boot', tier:9, stats:{DEX:45,CON:22,dodgeBonus:12},         desc:'Walks between worlds. The apex of mastery.'},
};
