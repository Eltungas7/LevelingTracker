...
const ITEMS_DB = {
  ...
  f_swrd_1: {id:'f_swrd_1', name:'Bronze Sword',      slot:'weapon',   rarity:'common',    emoji:'🗡️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1585.png', crafted:true, tree:'swrd', tier:1, stats:{STR:2,ATK:5},                        desc:'The first blade any smith learns to forge.'},
  f_swrd_2: {id:'f_swrd_2', name:'Iron Sword',         slot:'weapon',   rarity:'common',    emoji:'🗡️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1588.png', crafted:true, tree:'swrd', tier:2, stats:{STR:4,ATK:10},                       desc:'Reliable iron forged through practice.'},
  f_swrd_3: {id:'f_swrd_3', name:'Steel Blade',        slot:'weapon',   rarity:'uncommon',  emoji:'⚔️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1601.png', crafted:true, tree:'swrd', tier:3, stats:{STR:7,ATK:17,DEX:2},                 desc:'Sharpened discipline in metal form.'},
  f_swrd_4: {id:'f_swrd_4', name:'Bastard Sword',      slot:'weapon',   rarity:'uncommon',  emoji:'⚔️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1665.png', crafted:true, tree:'swrd', tier:4, stats:{STR:11,ATK:26,DEX:4},                desc:'Versatile. Balanced. Built for serious work.'},
  f_swrd_5: {id:'f_swrd_5', name:'Crusader Claymore',  slot:'weapon',   rarity:'rare',      emoji:'⚔️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1703.png', crafted:true, tree:'swrd', tier:5, stats:{STR:17,ATK:38,DEX:7},                desc:'The weapon of those who show up every day.'},
  f_swrd_6: {id:'f_swrd_6', name:'Obsidian Blade',     slot:'weapon',   rarity:'rare',      emoji:'🗡️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1743.png', crafted:true, tree:'swrd', tier:6, stats:{STR:24,ATK:52,DEX:11,critBonus:2},   desc:'Dark, silent, devastatingly effective.'},
  f_swrd_7: {id:'f_swrd_7', name:'Runic Greatsword',   slot:'weapon',   rarity:'epic',      emoji:'⚔️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1715.png', crafted:true, tree:'swrd', tier:7, stats:{STR:33,ATK:70,DEX:16,critBonus:5},   desc:'Ancient runes etched through months of dedication.'},
  f_swrd_8: {id:'f_swrd_8', name:'Dragonfang',         slot:'weapon',   rarity:'epic',      emoji:'🔥', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1735.png', crafted:true, tree:'swrd', tier:8, stats:{STR:44,ATK:92,DEX:22,critBonus:8},   desc:'The tooth of ambition. Demands mastery to wield.'},
  f_swrd_9: {id:'f_swrd_9', name:"Godslayer's Edge",   slot:'weapon',   rarity:'legendary', emoji:'⚔️', img:'Assets/Free - Raven Fantasy Icons/Free - Raven Fantasy Icons/Separated Files/16x16/fa1754.png', crafted:true, tree:'swrd', tier:9, stats:{STR:58,ATK:120,DEX:30,critBonus:12}, desc:'Forged through absolute dedication. Beyond all limits.'},
